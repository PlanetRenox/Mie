...
namespace Fragsurf.Movement {
    ...
    /// <summary>
    /// Easily add a movable character to the scene
    /// </summary>
    [AddComponentMenu ("Fragsurf/Move Character")]
    public class MoveCharacter : MonoBehaviour, IMoveControllable {
        ...
        private MoveController _controller = new MoveController ();
